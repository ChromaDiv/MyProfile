...
export function CaseStudies() {
  return (
    <section id="case-studies" className="glass-section py-24 px-6 md:px-12 print:py-0 print:px-0">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="space-y-10 print:space-y-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative p-8 md:p-10 rounded-[2rem] bg-white/40 dark:bg-background/40 border border-accent/10 overflow-hidden print:bg-white print:border-slate-300 print:rounded-none"
          >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="group overflow-hidden rounded-[2rem] border border-foreground/5 bg-white/40 dark:bg-background/40 hover:border-accent/30 transition-all duration-500 print:border-slate-300 print:rounded-none"
          >
            <div className="grid grid-cols-1 lg:grid-cols-12">
              {/* Sidebar Metadata */}
              <div className="lg:col-span-4 p-8 lg:p-10 bg-white/60 dark:bg-background/60 border-b lg:border-b-0 lg:border-r border-foreground/5 print:border-r">
                <div className="flex flex-col h-full justify-between">
                  ...
                  <div className="mt-12 space-y-4">
                    <div className="p-4 rounded-xl bg-white/80 dark:bg-background/60 border border-accent/10">
              ...
              <div className="lg:col-span-8 p-8 lg:p-10 space-y-8">
                ...
                <div className="pt-8 border-t border-foreground/5 space-y-6">
                  <div className="gap-4 group/item">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-12 md:p-16 rounded-[2rem] border-2 border-dashed border-accent/20 text-center bg-white/40 dark:bg-background/40 print:bg-white print:border-slate-300"
          >
