...
export function Contact() {
  ...
  return (
    <section id="contact" className="glass-section py-32 px-6 md:px-12">
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 relative z-10">
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 group">
                <div className="w-12 h-12 rounded-xl bg-white/80 dark:bg-background/60 flex items-center justify-center text-accent border border-accent/20 group-hover:bg-accent group-hover:text-black transition-all duration-300">
                  <Linkedin size={20} />
                </div>
                <div>
            ...
            <div className="p-6 rounded-2xl bg-white/40 dark:bg-background/40 border border-foreground/5 inline-flex items-center gap-4">
          ...
          >
            <GlassCard hoverEffect={false} className="p-8 md:p-10 border-foreground/5 bg-white/40 dark:bg-background/40">
              {success ? (
                <motion.div
