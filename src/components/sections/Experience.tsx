...
export function Experience() {
  return (
    <section id="experience" className="glass-section py-24 px-6 md:px-12">
        ...
        >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl border border-foreground/5 bg-white/40 dark:bg-background/40 flex flex-col">
              ...
              {timeline.map((job, idx) => (
                ...
                >
                  <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-4">
                    ...
                    <span className="px-4 py-1.5 rounded-full bg-white/60 dark:bg-background/60 text-[10px] font-mono font-bold uppercase tracking-tighter">
                      {job.period}
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {job.skills.map(skill => (
                      <span key={skill} className="px-2 py-1 bg-white/80 dark:bg-background/60 text-accent border border-accent/10 rounded text-[10px] font-mono uppercase font-bold">
                        {skill}
                      </span>
                    ))}
                  </div>
            ...
            <div className="space-y-8 relative before:absolute before:left-[-20px] before:top-4 before:bottom-4 before:w-[1px] before:bg-foreground/10">
              {education.map((edu, idx) => (
                ...
                >
                  ...
                  {edu.focus && (
                    <div className="mt-3 inline-flex items-center gap-2 px-2 py-0.5 bg-white/60 dark:bg-background/60 rounded text-[10px] font-bold text-foreground/40 dark:text-foreground/60 uppercase">
                      Focus: {edu.focus}
                    </div>
                  )}
