...
export function Impact() {
  ...
  return (
    <section ref={containerRef} className="glass-section py-24 px-6 md:px-12">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="lg:w-5/12 sticky top-24">
              <motion.div
                ...
                className="space-y-6"
              >
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/80 dark:bg-background/60 border border-blue-600/20">
                ...
                <div className="p-6 rounded-3xl bg-white/60 dark:bg-background/40 border border-blue-500/10 italic text-foreground/80 relative overflow-hidden group">
                  ...
                  >
                    <GlassCard className="p-1 px-1 overflow-hidden group hover:border-blue-500/30 transition-all duration-500">
                      <div className="flex flex-col md:flex-row items-stretch gap-0 md:gap-6">
                        ...
                        <div className="md:w-1/4 p-6 flex flex-col justify-between items-start border-b md:border-b-0 md:border-r border-foreground/5 bg-white/40 dark:bg-background/60">
