      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 w-[calc(100vw-3rem)] md:w-[380px] h-[550px] max-h-[85vh] flex flex-col"
          >
            <GlassCard className="flex flex-col h-full p-0 overflow-hidden shadow-2xl border-white/20 dark:border-accent/20 bg-background/95 backdrop-blur-2xl">
              {/* Header */}
              <div className="flex items-center justify-between p-4 border-b border-foreground/10 bg-accent/5">
